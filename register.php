		...
		<div class="register_css">
			...
			<div class="register_form_wrapper">
				...
				<form action="" method="POST" class="register_form">
					...
					Mobile Phone
					<br/>
					<input type="text" class="register_input" name="mobile_no" placeholder="Phone Number" size="47.50" ></input>
					
					
					<br/><br/>
					Account No.
					<br/>
					<input type="text" class="register_input" name="acc_no" placeholder="number" size="47.50" ></input>
